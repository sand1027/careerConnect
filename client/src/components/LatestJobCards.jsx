...
const LatestJobCards = ({ job }) => {
    ...
    return (
        <motion.div
            ...
            className="p-6 rounded-lg shadow-md bg-white border border-gray-200 cursor-pointer transition-all duration-300"
        ...
        >
            ...
            <div className="flex items-center gap-2 mt-4">
                ...
                <Badge className="bg-orange-100 text-[#F83002] font-semibold" variant="ghost">
                    { job?.jobType }
                </Badge>
                <Badge className=" text-blue-400 font-semibold" variant="ghost">
                    { job?.salary } LPA
                </Badge>
            </div>
        </motion.div>
